...
// TestPointIDIsStableAndUUIDShaped lives in package qdrant (qdrant_test.go) —
// PointID is qdrant's, not rag's.
...
// TestPostBacksOffWithinItsTotalBudget, TestPostRetriesDroppedConnections and
// TestPostDoesNotRetryADeadContext live in package providers
// (openai_compat_test.go) — OpenAICompat.post is theirs.
